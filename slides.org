...
* Template literals (Angular 19.2)
...
I decoratori tuttavia offrono ancora vantaggi in situazioni in cui si necessita di opzioni avanzate come ad esempio ~{ static: true }~, utili per l'accesso a elementi già presenti all'inizializzazione del componente.
L'uso di ~viewChild~ e ~viewChildren~ permette l'uso di altre opzioni come ad esempio ~~
